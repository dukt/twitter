...
class Twitter_TweetFieldType extends BaseFieldType
{
    ...
    public function getInputHtml($name, $value)
    {
        ...
        if(!craft()->twitter->checkDependencies())
        {
            $html .= '<p class="error">'.Craft::t("Twitter plugin is not configured properly. Please check {url} for more informations.", array('url' => Craft::t('<a href="'.UrlHelper::getUrl('settings/plugins/twitter').'">{title}</a>', array('title' => 'Twitter plugin settings')))).'</p>';
        }
